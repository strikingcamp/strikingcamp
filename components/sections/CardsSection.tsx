...
import { publicDisciplineList } from "@/data/disciplines";
    ...
    <section id="disciplines" className="bg-transparent py-20 sm:py-28 relative z-10 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-stretch">
          {publicDisciplineList.map((card, index) => (
            <motion.div
              key={card.slug}
              ...
              className="group relative overflow-hidden min-h-[360px] rounded-2xl flex flex-col justify-end p-6 sm:p-8 border border-brand-white/10 bg-[#0c1322] transition-all duration-300 hover:border-brand-blue/40 shadow-xl hover:shadow-brand-blue/5 hover:-translate-y-1"
            >
              ...
              <div className="relative z-10 flex flex-col justify-end h-full">
                ...
                <p className="text-brand-white/75 font-light text-xs sm:text-sm leading-relaxed mb-4 line-clamp-3">
