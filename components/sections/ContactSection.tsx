        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-[#00d8ff] text-white font-bold py-3 rounded-md hover:bg-cyan-400 transition-colors uppercase tracking-wider shadow-md"
              >
                Envoyer
              </button>
            </form>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:striking_camp13@gmail.com" className="text-gray-300 mt-1 hover:text-[#00d8ff] transition-colors">
                      striking_camp13@gmail.com
                    </a>
                  </div>
                </div>
              </div>
