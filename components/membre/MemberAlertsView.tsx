...
const mockAlertsPreview: AlertItem[] = [
  {
    ...
    title: "Nouvel événement Striking Camp",
    message: "Un nouvel événement vient d'être publié : Stage Technique Muay Thaï & Corps-à-Corps avec Coach Mahfoud.",
    date: "Aujourd'hui",
    isRead: false,
  ...
  },
  {
    ...
    message: "Votre place pour la séance Small Group Kick Boxing (Mardi à 18:00) est confirmée.",
    date: "Il y a 10 min",
    isRead: false,
  },
  {
    ...
    message: "N’oubliez pas votre entraînement Boxing Bag demain à 07:00. Pensez à vos gants et bandages.",
    date: "Il y a 2h",
    isRead: false,
  },
  {
    id: "4",
    type: "club_info",
    title: "Information importante du club",
    message: "Le Striking Camp accueillera des créneaux supplémentaires pendant les vacances scolaires.",
    date: "Hier",
    isRead: true,
  },
  {
    ...
    type: "annulation",
    title: "Annulation",
    message: "Votre annulation de séance a bien été prise en compte.",
    date: "Il y a 3 jours",
    isRead: true,
  },
];
